...
const foods = [
    ...
    {
        title: "Vege Curry Croquette",
        description: "Croquettes are these deep-fried breaded rolls made of mashed potatoes or meat, veggies and much more. ",
        price: "$11.30",
    ...
    {
        title: "Pork Curry ",
        description: "Similar to the other curry's, but with pork!",
        price: "$11.30",
        image: "https://images.mryum.com/api/2/img/prod/b5c65dcc-d5cc-4862-a69c-78bcbd09bc8f/image-original/fit?size=500x500&auth=NDI4ODAwMzkxNg__"
    },
    {
        title: "Pepsi",
        description: "600ml bottle of Pepsi.",
        price: "$4.90",
