...
const foods = [
  {
    ...
    price: "$8.20",
    image:
      "https://www.guzmanygomez.com.au/wp-content/uploads/2021/05/1128x612-AUS-Burrito-Chicken.jpg",
  },
  {
    title: "Burrito Bowl",
    description:
    ...
    price: "$8.20",
    image:
      "https://images.mryum.com/api/2/img/prod/186a087c-dcd5-4a7b-aaa8-c9b9288f6b88/image-original/fit?size=500x500&auth=NDI4ODAwMzkxNg__",
  },
  {
    title: "Nachos",
    ...
    price: "$11.30",
    image:
      "https://images.mryum.com/api/2/img/prod/b5c65dcc-d5cc-4862-a69c-78bcbd09bc8f/image-original/fit?size=500x500&auth=NDI4ODAwMzkxNg__",
  },
  {
    title: "$3 Tacos",
    description:
      "Whether it's family taco night or simply a tasty top up, the $3 Taco takes the traditional taco kit and makes it cleaner, easier and better value than ever! ",
    price: "$3.00",
    image:
      "https://images.mryum.com/api/2/img/prod/140de059-996d-4401-a959-e328494c0277/image-original/fit?size=500x500&auth=NDI4ODAwMzkxNg__",
  },
  {
    title: "Nachos",
    description:
      "Nothing says 'let's party' like nachos! We take our house-made corn chips and load them up with the filling of your choice.",
    price: "$9.50",
    image:
      "https://images.mryum.com/api/2/img/prod/b5c65dcc-d5cc-4862-a69c-78bcbd09bc8f/image-original/fit?size=500x500&auth=NDI4ODAwMzkxNg__",
  },
  ...
  },
  {
    ...
    price: "$11.30",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1WLymbwnwlLBeHdBO9QJB3suRYLmt_Zwo3Q&usqp=CAU",
  },
];

// const onSend = (burrito) => console.log("yes");

const onSend = (food, id, cost) => {
  addDoc(collection(database, "OrderHistory"), {
    // _id,
    // createdAt,
    // text,
    // user,
      ...
      {foods.map((food, index) => (
        <View key={index}>
          ...
          <Button
            ...
            onPress={() => onSend(food.title, global.orderID, food.price)}
          />
          <Divider />
        </View>
      ))}
